  ...
  return (
    <section className="py-16 bg-base-100">
      <div className="container mx-auto px-4">
        <h1 className="text-5xl italic text-center mb-12" data-aos="fade-up">Tentang Kami</h1>
        <div className="bg-base-200 rounded-xl p-8 max-w-4xl mx-auto flex flex-col md:flex-row gap-8 items-center md:items-start shadow" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="flex-1 min-w-0" data-aos="fade-right" data-aos-delay="200">
            <div className="mb-4 text-xl italic" data-aos="fade-right" data-aos-delay="300">About Travel Website</div>
            ...
            <button className="btn btn-link px-0 text-base-content/80" data-aos="fade-right" data-aos-delay="500">LEARN MORE</button>
          </div>
          {/* Right: Profile */}
          <div className="w-full md:w-64 flex flex-col items-center bg-base-100 rounded-xl p-6 shadow-sm" data-aos="fade-left" data-aos-delay="300">
            ...
            />
            <div className="italic text-lg mb-2" data-aos="fade-left" data-aos-delay="400">John Doe</div>
            ...
            <button className="btn btn-link px-0 text-base-content/80" data-aos="fade-left" data-aos-delay="600">MORE ABOUT JOHN</button>
          </div>
        </div>
      </div>
    </section>
