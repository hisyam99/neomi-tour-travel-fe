  ...
  return (
    <main className="pt-16">
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row gap-8 mt-8">
        <div className="w-full md:w-2/3" data-aos="fade-right" data-aos-duration="1000">
          {/* <Section2 roomId={roomId} /> */}
          <Section3 roomId={roomId} />
        </div>
        <div className="w-full md:w-1/3" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
